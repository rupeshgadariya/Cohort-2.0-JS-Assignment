...
export function parseWhatsAppMessage(message) {
  ...
  const wordCount = message.split(" ").filter(obj => (obj.trim() !== "")).length

  let sentiment = "neutral";

  if (message.toLowerCase().includes("haha") ||
    ...
    message.toLowerCase().includes("pyaar")
  ) sentiment = "love"

  return { date: date[0], time: time[0], sender: sender[0], text, wordCount, sentiment };
}


const msg = "01/12/2024, 09:15 - Priya: I love this song        ";
